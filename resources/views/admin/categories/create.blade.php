...
<div class="mb-4">
    ...
    <h2 class="playfair">Ajouter une nouvelle catégorie</h2>
</div>
            ...
            <div class="card-body p-4">
                <form action="{{ route('admin.categories.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Ex: Maison, Villa, Appartement..." required autofocus>
                        @error('name')
